...
If words such as *interface*, *representation*, *task*, and *feedback* are new,
complete [HCI Basics Through Everyday Apps](../06-hci-with-everyday-apps.md)
before this project tutorial.
If Copilot is being used in class, also complete the
[GitHub Copilot Setup for Students](complete-copilot-setup.md).
...
The [GitHub Copilot Setup for Students](complete-copilot-setup.md)
